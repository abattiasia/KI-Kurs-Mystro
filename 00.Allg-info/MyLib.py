...
Define the Class: 
    ...
    ○ The class should have the following attributes: make, model, year, and odometer_reading.
Constructor Method: 
    ○ Define an init method to initialize these attributes. The odometer_reading should be initialized to 0.
Methods: 
    ○ Define a method named get_description that returns a neatly formatted descriptive name for the car. 
    ○ Define a method named read_odometer that prints a statement showing the car's mileage. 
    ○ Define a method named update_odometer that sets the odometer reading to a given value. This method should reject any attempt to roll back the odometer. 
    ○ Define a method named increment_odometer that increments the odometer reading by a given amount.
"""
...
Ex. 02
Define the Class: 
    ○ Create a class named Dog. ○ The class should have the following attributes: name and age.
Constructor Method: 
...
Methods: 
    ...
    ○ Define a method named roll_over that prints a message indicating the dog is rolling over.
"""
...
Define the Class: 
    ○ Create a class named Student. ○ The class should have the following attributes: name and courses.
Constructor Method: 
    ○ Define an init method to initialize the name attribute and initialize courses as an empty list.
Methods: 
    ○ Define a method named enroll that takes a course name as a parameter and appends it to the courses list. 
    ○ Define a method named get_courses that prints the list of courses the student is enrolled in.
"""
class Student():
